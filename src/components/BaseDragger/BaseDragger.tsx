...
import { useDropzone, DropzoneOptions, DropzoneState, FileRejection, DropEvent } from 'react-dropzone';
...
const BaseDragger: React.FC<BaseDraggerProps> = ({
  ...
  return (
    ...
    >
      <input {...getInputProps()} />
      {children || <p>Drag & drop a CSV file here, or click to select a file</p>}
    </div>
  );
};
